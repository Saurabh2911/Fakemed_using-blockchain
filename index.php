...
<html lang="en">
  <head>
    ...
    <title>FakeMed - Decentralized Application</title>
  ...
  <div>
	...
	<center><img src="images/fakemed3.png" style="width:250px;height=250px"></center>
	</div>
    <div style="width: 100%">
	
      <center>
      <div class="loginformcard" id="card1">
            <h2 style="font-size:300% "> Welcome To FakeMed </h2>
            <p style="max-width: 80%;">
            FakeMed is a decentralized webapp based on blockchain. In this webapp data from the frieght to manufacuring everything is saved in the secured blockchain which helps users to track each and every information about the medicine by scanning qr code.
            </p>
